export default function EventCard({ clubName, eventName, evDate }){
    return(
        <a href={'/events/'+eventName}>
            <div className='inline-block bg-black h-[400px] w-[600px] bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 rounded-2xl p-4 mx-8 my-8 transform hover:scale-110 transition duration-300'>
