export default function ClubCard({ clubName, clubText }){
    return(
        <a href={'/clubs/' + clubName}>
            <div className='inline-block bg-slate-900 h-[400px] w-[600px] bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 rounded-2xl p-4 mx-8 transform hover:scale-110 transition duration-300 my-4'>
